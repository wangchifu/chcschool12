                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php 
                                    $club_student_num = \App\Models\ClubStudent::where('semester',$lunch_setup->semester)
                                        ->where('disable', null)
                                        ->orderBy('semester')
                                        ->orderBy('class_num')
                                        ->count();
                                    $student_class_num = \App\Models\StudentClass::where('semester',$lunch_setup->semester)
