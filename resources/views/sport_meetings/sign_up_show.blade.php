                                ...
                                @if($item->group==1 or $item->group==3)
                                    @if($item->game_type=="personal")
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <?php
                                                $boys_sign = \App\Models\StudentSign::where('action_id',$action->id)->where('item_id',$item->id)->where('sex','男')->where('student_year',$student_year)->where('student_class',$student_class)->get();
                                                ?>
                                ...
                                @if($item->group==2 or $item->group==3)
                                    @if($item->game_type=="personal")
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <?php
                                                $girls_sign = \App\Models\StudentSign::where('action_id',$action->id)->where('item_id',$item->id)->where('sex','女')->where('student_year',$student_year)->where('student_class',$student_class)->get();
                                                ?>
                                ...
                                @if($item->group==4)
                                    @if($item->game_type=="personal")
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <?php
                                                $students_sign = \App\Models\StudentSign::where('action_id',$action->id)->where('item_id',$item->id)->where('sex','4')->where('student_year',$student_year)->where('student_class',$student_class)->get();
                                                ?>
