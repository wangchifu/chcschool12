                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($v=="報修系統")
                                                ...
                                                <?php
                                                    $user_powers = \App\Models\UserPower::where('name',$v)->where('type','A')->get();
                                                ?>
                                            ...
                                            @elseif($v=="教師差假")
                                                ...
                                                <?php
                                                $user_powers = \App\Models\UserPower::where('name',$v)->where('type','B')->get();
                                                ?>
                                                @foreach($user_powers as $user_power)
                                                    已指定「人事主任權限」：
                                                    {{ $user_power->user->name }}<a href="{{ route('user_powers.destroy',$user_power->id) }}" onclick="return confirm('確定刪除？')"><i class="text-danger fas fa-times-circle"></i></a>,
                                                ...
                                                <?php
                                                $user_powers = \App\Models\UserPower::where('name',$v)->where('type','C')->get();
                                                ?>
                                                @foreach($user_powers as $user_power)
                                                    已指定「會計主任權限」：
                                                    {{ $user_power->user->name }}<a href="{{ route('user_powers.destroy',$user_power->id) }}" onclick="return confirm('確定刪除？')"><i class="text-danger fas fa-times-circle"></i></a>,
                                                ...
                                                <?php
                                                $user_powers = \App\Models\UserPower::where('name',$v)->where('type','D')->get();
                                                ?>
                                                @foreach($user_powers as $user_power)
                                                    已指定「單位主管權限」：
                                                    {{ $user_power->user->name }}<a href="{{ route('user_powers.destroy',$user_power->id) }}" onclick="return confirm('確定刪除？')"><i class="text-danger fas fa-times-circle"></i></a>,
                                                ...
                                                <?php
                                                $user_powers = \App\Models\UserPower::where('name',$v)->where('type','E')->get();
                                                ?>
                                                @foreach($user_powers as $user_power)
                                                    已指定「教學組長權限」：
                                                    {{ $user_power->user->name }}<a href="{{ route('user_powers.destroy',$user_power->id) }}" onclick="return confirm('確定刪除？')"><i class="text-danger fas fa-times-circle"></i></a>,
