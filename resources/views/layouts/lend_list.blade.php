<?php
$lend_orders = \App\Models\LendOrder::orderBy('id','DESC')
            ->paginate(10);
        
        $lend_orders2 = \App\Models\LendOrder::where('lend_date',date('Y-m-d'))
            ->get();

        $lend_orders3 = \App\Models\LendOrder::where('back_date',date('Y-m-d'))
            ->get();     
