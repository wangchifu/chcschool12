<?php
$fix_classes = \App\Models\FixClass::where('disable',null)->orderBy('order_by')->get();
$n=1;
?>
...
<div class="tab-content" id="myTabContent">
  <?php
  $fixes = \App\Models\Fix::where('situation','!=',1)->orderBy('situation','DESC')->orderBy('created_at','DESC')->paginate(10);
  ?>
<div class="tab-pane fade show active" id="fix-home" role="tabpanel" aria-labelledby="fix-home-tab">
  ...
  @foreach($fix_classes as $fix_class)
  <?php
  $fixes = \App\Models\Fix::where('situation','!=',1)->where('type',$fix_class->id)->orderBy('situation','DESC')->orderBy('created_at','DESC')->paginate(10);
  ?>    
